...
(function($, window, document, undefined) {
  ...
  var Timepicker = function(element, options) {
    ...
    this.minuteliên = options.minuteliên;
    this.modalBackdrop = options.modalBackdrop;
    this.secondliên = options.secondliên;
  ...
  Timepicker.prototype = {
    ...
    decrementMinute: function(liên) {
      var newVal;

      if (liên) {
        newVal = this.minute - liên;
      } else {
        newVal = this.minute - this.minuteliên;
      }
    ...
    decrementSecond: function() {
      var newVal = this.second - this.secondliên;
    ...
    incrementMinute: function(liên) {
      var newVal;

      if (liên) {
        newVal = this.minute + liên;
      } else {
        newVal = this.minute + this.minuteliên - (this.minute % this.minuteliên);
      }
    ...
    incrementSecond: function() {
      var newVal = this.second + this.secondliên - (this.second % this.secondliên);
      ...
      if (!this.$element.val()) {
        if (defaultTime === 'current') {
          var dTime = new Date(),
            ...
            minutes = Math.floor(dTime.getMinutes() / this.minuteliên) * this.minuteliên,
            seconds = Math.floor(dTime.getSeconds() / this.secondliên) * this.secondliên,
            meridian = 'AM';
