...
CKEDITOR.lang['vi'] =
{
	...
	link :
	{
		...
		emailSubject		: 'Title thông điệp',
		emailBody		: 'Nội dung thông điệp',
		noAnchors		: '(Không có điểm neo nào trong document)',
	...
	spellCheck :
	{
		...
		ieSpellDownload	: 'Chức năng kiểm tra chính tả chưa được Setting. Bạn có muốn tải về ngay bây giờ?'
	},
	...
	pastefromword :
	{
		confirmCleanup	: 'Văn bản bạn muốn dán có kèm định dạng của Word. Bạn có muốn Type bỏ định dạng Word trước khi dán?',
	...
	scayt :
	{
		...
		addWord			: 'Thêm từ',
		emptyDic		: 'Tên của từ điển Can not be empty.',

		optionsTab		: 'Tùy chọn',
		allCaps			: 'Không phân biệt chữ HOA chữ thường',
		ignoreDomainNames : 'Bỏ qua tên miền',
		mixedCase		: 'Không phân biệt Type chữ',
	...
	toolbarCollapse	: 'collapse thanh công cụ',
	...
	docprops :
	{
		label : 'Thuộc tính document',
		title : 'Thuộc tính document',
		design : 'Thiết kế',
		meta : 'Siêu dữ liệu',
		chooseColor : 'Chọn màu',
		other : '<khác>',
		docTitle :	'Title Trang',
		...
		charsetWE : 'Tây Âu',
		docType : 'Kiểu Đề mục document',
		docTypeOther : 'Kiểu Đề mục document khác',
		...
		marginRight : 'Phải',
		marginBottom : 'Dưới',
		metaKeywords : 'Các từ khóa chỉ mục document (phân cách bởi dấu phẩy)',
		metaDescription : 'Mô tả document',
		metaAuthor : 'Tác giả',
