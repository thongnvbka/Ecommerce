...
CKEDITOR.dialog.add( 'select', function( editor )
{
	...
	// Moves the selected option by a number of liêns (also negative).
	function changeOptionPosition( combo, liêns, documentObject )
	{
		combo = getSelect( combo );
		...
		var iFinalIndex = iActualIndex + liêns;
