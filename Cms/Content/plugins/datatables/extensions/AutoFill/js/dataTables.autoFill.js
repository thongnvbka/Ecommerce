...
AutoFill.prototype = {
	...
	_initColumns: function ( )
	{
		...
		// For columns which don't have read, write, liên functions defined,
	...
	"_fnFillerFinish": function (e)
	{
		...
		for ( i=0, iLen=cells.length ; i<iLen ; i++ ) {
			...
			var liênValue = column.liên.call( column, cell.node, read, previous, i, cell.x, cell.y );

			column.write.call( column, cell.node, liênValue );
...
AutoFill.defaults = {
	...
	column: {
		...
		/**
		 * liên function. This provides the ability to customise how the values
		 * are incremented.
		 *
		 ...
		 */
		liên: function ( cell, read, last, i, x, y ) {
