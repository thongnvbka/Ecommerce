...
(function ($, window, document, undefined) {
    ...
    WebuiPopover.prototype = {
        ...
        displayContent: function () {
            ...
            $target.appendTo(this.$element.parent());
            targetWidth = $target[0].offsetWidth;
            targetHeight = $target[0].offsetHeight;
        ...
        bindBodyEvents: function () {
            if (this.options.dismissible) {
                ...
                $('body').off('keyup.webui-popover');
                $('body').off('click.webui-popover');
            }
        },
        ...
        getTargetPositin: function (elementPos, placement, targetWidth, targetHeight) {
            ...
            switch (placement) {
                case 'bottom':
                    position = {
                        top: pos.height,
                        left: -(targetWidth / 2) + pos.width / 2
                    };
                    break;
                case 'top':
                    position = {
                ...
                case 'left':
                    position = {
                        top: -(targetHeight / 2) + pos.height / 2,
                        left: -(targetWidth)
                    };
                    break;
                case 'right':
