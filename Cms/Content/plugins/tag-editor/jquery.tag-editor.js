            ...
            ed.on('click', '.tag-editor-tag', function (e) {
                ...
                if (!$(this).hasClass('active')) {
                    ...
                    if (o.autocomplete) {
                        ...
                        aco.select = function (event, ui) { if (ac_select) ac_select(event, ui); setTimeout(function () { $('.active', ed).find('input').trigger('autogrow'); }, 20); };
                        if (aco._renderItem) {
                            input.autocomplete(aco).autocomplete("instance")._renderItem = aco._renderItem;
                        } else {
