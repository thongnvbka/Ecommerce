System.register(['@angular/core', '@angular/http', 'rxjs/Rx'], function(exports_1, context_1) {
    ...
    return {
        setters:[
            ...
            function (_1) {}],
        execute: function() {
            RoleActionService = (function () {
                function RoleActionService(http) {
                    this.http = http;
                }
                RoleActionService.prototype.setHeaders = function () {
                    this.headers = new http_1.Headers();
                    this.headers.append('Content-Type', 'application/json');
                    this.headers.append('Accept', 'application/json');
                    this.headers.append('Authorization', 'Bearer ' + localStorage.getItem('access_token'));
                };
                RoleActionService.prototype.getAll = function () {
                    var url = "/role-action/all";
                    this.setHeaders();
                ...
                RoleActionService = __decorate([
                    core_1.Injectable(), 
                    __metadata('design:paramtypes', [http_1.Http])
                ], RoleActionService);
                return RoleActionService;
            }());
            exports_1("RoleActionService", RoleActionService);
        }
    }
});
//# sourceMappingURL=role-action.service.js.map