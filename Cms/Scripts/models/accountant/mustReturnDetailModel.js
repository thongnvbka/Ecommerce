var mustReturnDetailModel = function () {
    ...
    this.CurrencyDiscount = ko.observable("");
    this.CurrencyReal = ko.observable("");
    ...
    this.SubjectTypeId = ko.observable("");
    this.SubjectTypeName = ko.observable("");
