statusApp = {
    ...
    order: [
        { Name: "New", Class: "label label-default", Ifa: "fa fa-file-o bg-gray" },
        { Name: "รอเเจ้งราคา", Class: "label label-warning", Ifa: "fa fa-clock-o bg-yellow" },
        { Name: "กำลังเเจ้งราคา", Class: "label label-warning", Ifa: "fa fa-calendar-check-o bg-blue" },
        { Name: "รอชำระ", Class: "label label-info", Ifa: "fa fa-exclamation-triangle bg-yellow" },
        { Name: "รอสั่งสินค้า", Class: "label label-warning", Ifa: "fa fa-cart-plus bg-gray" },
        { Name: "กำลังสั่งซื้อ", Class: "label label-warning", Ifa: "fa fa-cart-arrow-down bg-yellow" },
        { Name: "รอฝ่ายบัญชีชำระ", Class: "label label-warning", Ifa: "fa fa-exclamation-triangle bg-yellow" },
        { Name: "ฝ่ายบัญชีกำลังชำระ", Class: "label label-warning", Ifa: "fa fa-cc-visa bg-yellow" },
        ...
        { Name: "โกดังรับสินค้า", Class: "label label-info", Ifa: "fa fa-cubes bg-yellow" },
        { Name: "ขนส่ง", Class: "label label-info", Ifa: "fa fa-truck bg-aqua" },
        { Name: "รอส่งของ", Class: "label label-info", Ifa: "fa fa-truck bg-yellow" },
        { Name: "กำลังส่งของ", Class: "label label-info", Ifa: "fa fa-home bg-green" },
        { Name: "สำเร็จ", Class: "label label-success", Ifa: "fa fa-check bg-aqua" },
        { Name: "Cancel", Class: "label label-danger", Ifa: "fa fa-times-circle bg-red" },
        { Name: "ของเสีย หาย", Class: "label label-danger", Ifa: "fa user-times bg-red" }
    ],
    ...
    statusRequestShip: [
        ...
        { Name: "จัดการเรียบร้อยเเล้ว", Class: "label label-success" } 
    ],
