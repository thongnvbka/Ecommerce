...
namespace ProjectV.LikeOrderThaiLan.com.Items
{
    public class ActiveEmail
    {
        ...
        public ActiveEmail(string email, int systemId, DateTime sendDate, string domain)
        {
            this.Email = email;
            this.Code = PasswordEncrypt.PasswordEncrypt.GeneratePassword(20);
            this.SystemId = systemId;
            this.SendDate = sendDate;
            this.Link = domain + "/th/Account/Active-" + PasswordEncrypt.PasswordEncrypt.Base64Encode(this.ToString());
        }
    }
}
