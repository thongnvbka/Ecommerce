...
var GDTQ = 'https://'+window.location.host;
...
function syncData(){
   $.ajax({
      ...
      data: {
         "type": 1,
         "cart_data": getlocalData('cart_8b54d81e2e464b085b44ef1b7a8e191a'),
...
function getLevelInfo(){
   $.ajax({
      ...
      success: function(data) {
         if (data.error == 0) {
            setlocalData('f98b6997b040c07cc2f550b0c0bada5d',JSON.stringify(data.data) );//levelinfo
            // tmp = data.data;
         } else {
