...
{
    public class PackageNoCodeResult
    {
        ...
        #region PackageNoCode

        public int PackageNoCodeId { get; set; } // Id (Primary key)

        ///<summary>
        /// Kho ghi chú cho kiện hàng mất mã
        ///</summary>
        public string PackageNoCodeNote { get; set; } // Note
        ...
        /// 0: Mới tạo, 1: Đã đóng
        ///</summary>
        public byte PackageNoCodeStatus { get; set; } // Status

        ///<summary>
        /// Loại hàng mất mã: 0: Hàng mất mã, 1: Hàng kho yêu cầu đặt hàng xác nhận
        ///</summary>
        public int PackageNoCodeCommentNo { get; set; } // CommentNo
        public byte PackageNoCodeMode { get; set; } // Mode
        public string PackageNoCodeImageJson { get; set; } // ImageJson
        public DateTime PackageNoCodeCreated { get; set; } // Created
        public DateTime PackageNoCodeUpdated { get; set; } // Updated
