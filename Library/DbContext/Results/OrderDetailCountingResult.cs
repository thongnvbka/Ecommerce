...
{
    public class OrderDetailCountingResult
    {
        ...
        public int? QuantityBooked { get; set; } // Quantity

        public int? RequestLose { get; set; } // Quantity
        ///<summary>
        /// Số lượng kho nhận
        ///</summary>
        ...
        /// Số lượng thực
        ///</summary>
        public int? QuantityActual { get; set; } // Quantity
        ...
        public byte OrderStatus { get; set; } // CountingOfficeName (length: 300)
