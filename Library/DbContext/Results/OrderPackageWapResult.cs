...
{
    public class OrderPackageWapResult
    {
        ...
        /// Tiền đóng kiện gỗ của kiện hàng
        ///</summary>
        public decimal? TotalPriceWapperExchange { get; set; } // TotalPriceWapper
        ...
        public string WalletCode { get; set; } // CustomersUnsigned (length: 1000)
        ...
        ///<summary>
        /// Loại trùng mã vận đơn: dạng dứ liệu ";0;1;" or ";0;" or ";1;": Chứa 0: Trùng mã khách kho, chứ 1: Trùng mã khác khách
        ///</summary>
        public string Mode { get; set; } // Mode

        ///<summary>
        /// Trạng thái xử lý trùng mã vận đơn: 0: Mới, 1 Đã xử lý
        ///</summary>
        public byte SameCodeStatus { get; set; } // SameCodeStatus
    }
