...
{
        public partial class PayReceivableConfiguration : EntityTypeConfiguration<PayReceivable>
    {
        public PayReceivableConfiguration()
            : this("dbo")
        {
        }

        public PayReceivableConfiguration(string schema)
        {
            ToTable("PayReceivable", schema);
            HasKey(x => x.Id);
