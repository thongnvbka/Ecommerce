...
namespace Library.DbContext.Maps
{
    ...
    public partial class CustomerLogLoginConfiguration : EntityTypeConfiguration<CustomerLogLogin>
    {
        public CustomerLogLoginConfiguration()
            : this("dbo")
        {
        }

        public CustomerLogLoginConfiguration(string schema)
        {
            ToTable("CustomerLogLogin", schema);
            HasKey(x => x.Id);
