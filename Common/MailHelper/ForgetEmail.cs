...
namespace Common.MailHelper
{
    public class ForgetEmail
    {
        ...
        {
            itemString = global::Common.PasswordEncrypt.PasswordEncrypt.Base64Decode(itemString);
        ...
        public ForgetEmail(string email, int systemId, DateTime sendDate, string domain)
        {
            ...
            this.Link = domain + "/th/Account/NewPass-" + global::Common.PasswordEncrypt.PasswordEncrypt.Base64Encode(this.ToString());
        }
    }
}